...
def get_default_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "cursor_min_move_px": 6,         # px threshold; keeps tremor from wiggling cursor
        ...
        "relative_iris_gain_x": 48.0,    # Increased from 39.5
        "relative_iris_gain_y": 88.0,   # raise if can't reach top/bottom edges
        "gaze_smoothing_alpha": 0.6,
        "smooth_fast_thresh_px": 50,     # Lowered: faster response to intentional moves
        "smooth_slow_alpha": 0.12,      # smoothing weight when holding still (tremor damping)
        "gaze_dead_zone": 0.0018,         # iris noise floor; lower = more sensitive
